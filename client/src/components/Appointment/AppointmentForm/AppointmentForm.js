...
const AppointmentForm = ({ modalIsOpen, closeModal, appointmentOn, serialNo, maxSerialNo, date }) => {
    ...
    const onSubmit = data => {
        ...
        const doctor = {name: appointmentOn, selectedDate: getDayName(new Date(date)), maxSerialNo: maxSerialNo, serialNo:serialNo   }
        
        // fetch('http://localhost:5000/updateSerialNo', {
        //     method: 'PUT',
        ...
        .then(res => res.json())
        // .then (res => fetch('http://localhost:5000/updateSerialNo', {
        //     method: 'PUT',
        //     headers: { 'content-type': 'application/json' },
        //     body: JSON.stringify(doctor)
        // }))
